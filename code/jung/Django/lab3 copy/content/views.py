...
class Profile(APIView):
    def get(self, request): 
        ...
        return render(request, 'content/profile.html', context=dict(feed_list = feed_list, user=user, like_feed_list=like_feed_list, bookmark_feed_list=bookmark_feed_list))
