...
class CC_Verify {
    ...
    run() {
        let number_to_validate = parseInt(prompt("Enter a credit card number to validate; eg. [4556737586899855]: "));
        ...
        alert(`${number_to_validate} is ${this.validate_sum(number_list_sum, check_digit) ? 'valid!' : 'invalid.'}`);
    }
