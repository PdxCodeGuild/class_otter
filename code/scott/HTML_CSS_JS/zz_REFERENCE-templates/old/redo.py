...
def password():
    ...
    pwl = (request.form["please enter a Password length between 8 and 16:"])
    ucl = (request.form["How many characters should be Uppercase? (A -Z):"])
    lcl = (request.form["How many characters should be Lowercase? (a-z):"])
    nums = (request.form["How many characters should be numbers? (0 - 9)?:"])
    punc = (request.form["How many Punctuation Characters should be used?:"])
