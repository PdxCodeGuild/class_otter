...
pwl = input(int("please enter a Password length between 8 and 16:"))
ucl = input(int("How many characters should be Uppercase? (A -Z):"))
lcl = input(int("How many characters should be Lowercase? (a-z):"))
nums = input(int("How many characters should be numbers? (0 - 9)?:"))
punc = input(int("How many Punctuation Characters should be used?:"))
