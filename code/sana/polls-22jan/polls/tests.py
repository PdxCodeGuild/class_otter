...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        was published recently method should return false for 
...
class IndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        past_question = create_question(question_text="Pastquestion.", days=-10)
    ...
    def test_two_past_questions(self):
        question1 = create_question(question_text="future question.", days=-10)
        question2 = create_question(question_text="future question.", days=-31)
        response = self.client.get(reverse('polls:index'))
